 ...
 * @author ASUS
 */
@WebServlet(name = "ConfirmUnbanRequestController", urlPatterns = {"/ConfirmUnbanRequestController"})
public class ConfirmUnbanRequestController extends HttpServlet {

    
    private final static String ERROR = "error.jsp";
    private final static String SUCCESS = "unban.jsp";
