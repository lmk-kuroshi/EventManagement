<%-- 
    Document   : UnansweredQuestion
    Created on : Nov 22, 2021, 4:58:27 PM
    Author     : DELL
--%>
                        ...
                        <table class="content-table" width="90%">
                            <thead>
                                <tr>
                                    ...
                                    <th>Question</th>    
                                    <th>Your answer</th> 
                                    <th style="width:200px">Edit your answer</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span>
                                            <a href="editAnsweredQA.jsp?questionID=<%=QAM.getQuestionID()%>&mentorID=<%=QAM.getMentorID()%>&studentID=<%=QAM.getStudentID()%>&eventID=<%=QAM.getEventID()%>&eventName=<%=QAM.getEventName()%>&questionDetail=<%=QAM.getQuestionDetail()%>&reply=<%=QAM.getReply()%>"><%=QAM.getQuestionDetail()%></a><br>
                                        </span>
                                    </td>
                                    <td>
                                        <span>
                                            <a href="editAnsweredQA.jsp?questionID=<%=QAM.getQuestionID()%>&mentorID=<%=QAM.getMentorID()%>&studentID=<%=QAM.getStudentID()%>&eventID=<%=QAM.getEventID()%>&eventName=<%=QAM.getEventName()%>&questionDetail=<%=QAM.getQuestionDetail()%>&reply=<%=QAM.getReply()%>"><%=QAM.getReply()%></a><br>
                                        </span>
                                    </td>
                                    <td >
                                        <span>
                                            <a href="editAnsweredQA.jsp?questionID=<%=QAM.getQuestionID()%>&mentorID=<%=QAM.getMentorID()%>&studentID=<%=QAM.getStudentID()%>&eventID=<%=QAM.getEventID()%>&eventName=<%=QAM.getEventName()%>&questionDetail=<%=QAM.getQuestionDetail()%>&reply=<%=QAM.getReply()%>"><button>Edit answer</button></a><br>
                                        </span>
                                    </td>
