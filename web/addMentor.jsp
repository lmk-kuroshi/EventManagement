...
<html>
    <head>
        ...
        <link href="css/addMentorStyle.css" rel="stylesheet" />
                ...
                <div class="follow-card">
                    <div class="follow-align">
                        ...
                        <form action="MainController">
                            ...
                            <button type="submit" name="action" value="ConfirmAddMentor">Confirm Add Mentor</button>
                        </form>
                        ...
                        <form action="MainController">
                            ...
                            <input type="hidden" name="eventID" value="<%= eventID%>"/>
                            <input type="hidden" name="eventName" value="<%= eventName%>"/>
                            <button type="submit" name="action" value="ConfirmRemoveMentor">Confirm Remove Mentor</button>
                        </form>
                    </div>
                </div>
            </main>
