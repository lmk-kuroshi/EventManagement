                    ...
                    <div class="edit-event-align">
                        ...
                        <table class="content-table" width="90%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <img src="<%=event.getImage()%>" alt="Image Event" width="180px" height="auto"/>
                                    </td>
                                    <td>
                                    ...
                                    <!--  <td>
                                          <form action="MainController">
                                              <input type="hidden" name="eventID" value="<%= event.getEventID()%>"/>                            
                                              <button type="submit" name="action" value="CancelEvent">Cancel<br>Event</button>
                                          </form>
                                      </td>-->
                                    <td>
                                        <form action="MainController">
                                    ...
                                    <!--                                    <td>
                                                                            <form action="MainController">
                                                                                <input type="hidden" name="eventID" value="<%= event.getEventID()%>"/>                            
                                                                                <button type="submit" name="action" value="EditFollowup">Edit<br>Followup</button>
                                                                            </form>
                                                                        </td>-->
                                    <td>
